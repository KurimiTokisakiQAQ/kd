...
# 1) 更新飞书机器人 Webhook
WEBHOOK_URL = "https://open.feishu.cn/open-apis/bot/v2/hook/6f85f8e5-8312-45e7-89c0-7227d6ee9c54"

# 2) @ 多个用户的 open_id（包含原有 + 新增两个）
FEISHU_AT_OPEN_IDS = [
    "ou_20b2bd16a8405b93019b7291ec5202c3",
    "ou_67a21c98d7da7b4812f6e6eb60f9937f",
    "ou_344442b8c934b7c90c17263d543da419",
]
